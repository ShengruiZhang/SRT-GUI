...
import Exceptions.Wind as Wind
...
# ------ Menu Definition ------ #
menu_def = [
            ['&File', ['&Open', '&Save', 'Prope&rties', 'E&xit', ]],
...
coord_entry = [
                [sg.T('Coordinate Entry:', font="Helvetica 14 underline bold", background_color='gray')],
...
parameters = [
                [sg.T('Parameters:', font="Helvetica 14 underline bold", background_color='black')],
...
while True:  # Event Loop
    ...
    if event == '-UPDATE-':
        # When Update is pressed, retrieve ADC value from AFE
